...
class LazyResult(LazyOpResult):
    ...
    """
    # file_ and input_ could be merged but kept separate to emphasize they're distinct concepts;
    # lazy file is only used internally while lazy_data is used within WeldObject.context
    file_mapping = {}
    data_mapping = {}
    file_cache = {}
    data_cache = {}
